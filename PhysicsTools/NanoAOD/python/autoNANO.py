...
autoNANO = {
    ...
    'MUHLT' : {'sequence': 'DPGAnalysis/MuonTools/hltMuNtupleProducer_cff.hltMuNanoProducer',
               'customize': 'DPGAnalysis/MuonTools/hltMuNtupleProducer_cff.hltMuNanoCustomize'},
    # HCAL flavors:
