/** \class L1TkMuStubFlatTableProducer
 *
 *  \brief Producer of a flat table with L1TkMuons stubs information
 *
 *  This module produces a flat table containing information about the L1Tk Muons stubs in
 *  the muon chambers. Each row corresponds to a single stub, and includes features such as
 *  the eta region, phi region, depth region, type, and quality of the stub, together with
 *  an index linking it back to its parent L1Tk Muon.
 *
...
public:
  ...
  void produce(edm::Event &iEvent, const edm::EventSetup &iSetup) override {
    ...
    out->addColumn<int>("type", types, "Stub type: 0=Endcap, 1=Barrel (Run-3: 0=DT, 1=RPC Barrel, 2=CSC, 3=RPC Endcap");
