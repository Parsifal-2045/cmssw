...
Phase2L2MuToReuseV = MTVhlt.clone(
    ...
    label = ('phase2L3MuonFilter:L2MuToReuse',),
    muonHistoParameters = staMuonHistoParameters
)
...
Phase2l3IOTkFilteredV = MTVhlt.clone(
    ...
    label = ('phase2L3MuonFilter:L3IOTracksFiltered',),
    muonHistoParameters = trkMuonHistoParameters
)
...
Phase2l3OITkFilteredV = MTVhlt.clone(
    ...
    label = ('phase2L3MuonFilter:L3OITracksFiltered',),
    muonHistoParameters = trkMuonHistoParameters
)
...
phase2_common.toReplaceWith(muonValidationHLT_seq, Phase2MuonValidationHLT_seq)
