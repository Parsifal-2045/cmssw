...
phase2L2AndL3Muons.toModify(hltPhase2L3OISeedsFromL2Muons, src = cms.InputTag("phase2L3MuonFilter", "L2MuToReuse"))

from Configuration.ProcessModifiers.phase2L3MuonsOIFirst_cff import phase2L3MuonsOIFirst
(phase2L2AndL3Muons & phase2L3MuonsOIFirst).toModify(hltPhase2L3OISeedsFromL2Muons, src = cms.InputTag("hltL2MuonsFromL1TkMuon","UpdatedAtVtx"))
