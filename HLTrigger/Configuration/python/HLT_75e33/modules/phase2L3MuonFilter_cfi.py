...
phase2L3MuonFilter = cms.EDProducer('phase2HLTMuonSelectorForL3',
...
(phase2L2AndL3Muons & phase2L3MuonsOIFirst).toModify(phase2L3MuonFilter, l3Tracks = cms.InputTag("hltPhase2L3OIMuonTrackSelectionHighPurity"))
(phase2L2AndL3Muons & phase2L3MuonsOIFirst).toModify(phase2L3MuonFilter, IOFirst = cms.bool(False))
