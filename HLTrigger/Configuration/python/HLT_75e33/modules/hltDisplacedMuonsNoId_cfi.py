...
hltDisplacedMuonsNoId = cms.EDProducer("MuonIdProducer",
    CaloExtractorPSet = cms.PSet(
        ...
        TrackAssociatorParameters = cms.PSet(
            CSCSegmentCollectionLabel = cms.InputTag("hltMaskedMuonHits"),
            CaloTowerCollectionLabel = cms.InputTag("Notused"),
            DTRecSegment4DCollectionLabel = cms.InputTag("hltMaskedMuonHits"),
    ...
    TimingFillerParameters = cms.PSet(
        CSCTimingParameters = cms.PSet(
            ...
            CSCsegments = cms.InputTag("hltMaskedMuonHits"),
            MatchParameters = cms.PSet(
                CSCsegments = cms.InputTag("hltMaskedMuonHits"),
                DTradius = cms.double(0.01),
                DTsegments = cms.InputTag("hltMaskedMuonHits"),
    ...
    TrackExtractorPSet = cms.PSet(
        ...
        inputTrackCollection = cms.InputTag("hltDisplacedMuonsOITracks")
    ),
    ...
    inputCollectionLabels = cms.VInputTag("hltDisplacedMuonsOITracks", "hltDisplacedGlobalMuons", "hltDisplacedStandaloneMuons"),
