...
#undef BL_MAIN_FUSED_FIT_CASE
  ...
  //   [64..64+N-1] matXX0     the material walk (a function of the hit positions and of the reference the
  //                           walk uses: the cache freezes it at the first linearization's reference)
